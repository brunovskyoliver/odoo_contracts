...
class ContractAbstractContract(models.AbstractModel):
    ...
    partner_id = fields.Many2one(
        comodel_name="res.partner", string="Kontakt", index=True
    )
    pricelist_id = fields.Many2one(comodel_name="product.pricelist", string="Cenník")
    ...
    line_recurrence = fields.Boolean(
        string="Rozdielne obdobia fakturácie jednotlivých položiek?",
